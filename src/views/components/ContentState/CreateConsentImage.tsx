  ...
  return (
    <Row className='justify-content-center'>
      <Col sm='12' md='10' lg='7' className='mt-4 text-center'>
        Please share your phone number to get the lowest possible prices on all our insurances. To provide
        services, we need your financial information associated with your phone number. We will show you all
        the data we need to access and you'll have the choice to provide consent to our data request.
      </Col>
      <Col sm='12' md='10' lg='7' className='mt-4 text-center'>
